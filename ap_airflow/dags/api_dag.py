...
def save_posts(ti) -> None:
    ...
    with open('/home/eqops_dev/mantri/test/posts.json', 'w') as f:
        json.dump(posts[0], f)
...
with DAG(
    ...
    task_is_api_active.set_downstream(task_get_posts)
    task_get_posts.set_downstream(task_save)
