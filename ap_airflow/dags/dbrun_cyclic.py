...
def wait_till(hour: int, minute: int, second: int, dag):
    ...
    dag : [type]
        dag
    """
    target_time_str = f'next_execution_date.in_tz("Europe/Berlin").replace(hour={hour}, minute={minute}, second={second})'
...
scripts = "/home/eqops_dev/mantri/scripts"

start = DummyOperator(task_id="start", dag=dag)
end = DummyOperator(task_id='end', dag=dag)

hok_19 = sh_ssh_hook('gmatmd03.uk.db.com', 'eqops_dev')
tid_19 = "DBRUN_PURGE_TEMP_KEYS_p01"
cmd_19 = f"{scripts}/dbrun_purge_temp_keys.sh"

hok_20 = sh_ssh_hook('gmatmd03.uk.db.com', 'eqops_dev')
tid_20 = "DBRUN_PURGE_TEMP_KEYS_b01"
cmd_20 = f"{scripts}/dbrun_purge_temp_keys.sh"

tsk_19 = SSHOperator(task_id=tid_19, command=cmd_19, ssh_hook=hok_19, dag=dag)
tsk_20 = SSHOperator(task_id=tid_20, command=cmd_20, ssh_hook=hok_20, dag=dag)

start >> [tsk_19, tsk_20] >> end
